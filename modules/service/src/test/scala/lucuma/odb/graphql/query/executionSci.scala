  ...
  test("execute arc, flat, one science") {
    val setup: IO[Observation.Id] =
      for {
        ...
        s0 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthArc(0), ArcStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s0)
        s1 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthFlat(0), FlatStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
  ...
  test("we can start anywhere") {
    val setup: IO[InstrumentExecutionConfig] =
      for {
        ...
        s0 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthArc(5), ArcStep, gcalTelescopeConfig(15), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s0)

        s1 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthFlat(5), FlatStep, gcalTelescopeConfig(15), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s1)
  ...
  test("order doesn't matter") {
    val setup: IO[Observation.Id] =
      for {
        ...
        s0 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthFlat(0), FlatStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s0)
        ...
        _  <- addEndStepEvent(s1)
        s2 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthArc(0), ArcStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s2)
  ...
  test("irrelevant steps may be inserted") {
    val setup: IO[Observation.Id] =
      for {
        ...
        x0 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthArc(8), ArcStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        ...
        x2 <- recordStepAs(serviceUser, a, Instrument.GmosNorth, gmosNorthFlat(8), FlatStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
  ...
  test("execute the first atom, a step of the second, then fail a science dataset from the first") {
    val setup: IO[Observation.Id] =
      for {
        ...
        s0 <- recordStepAs(serviceUser, a0, Instrument.GmosNorth, gmosNorthArc(0), ArcStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s0)
        s1 <- recordStepAs(serviceUser, a0, Instrument.GmosNorth, gmosNorthFlat(0), FlatStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s1)
        ...
        s5 <- recordStepAs(serviceUser, a1, Instrument.GmosNorth, gmosNorthArc(5), ArcStep, gcalTelescopeConfig(15), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s5)
        s6 <- recordStepAs(serviceUser, a1, Instrument.GmosNorth, gmosNorthFlat(5), FlatStep, gcalTelescopeConfig(15), ObserveClass.ProgramCal)
  ...
  test("nextAtom id doesn't change while executing") {
    val setup: IO[(List[Atom.Id], List[Atom.Id])] =
      for {
        ...
        a1 <- recordAtomAs(serviceUser, Instrument.GmosNorth, v, SequenceType.Science)
        s5 <- recordStepAs(serviceUser, a1, Instrument.GmosNorth, gmosNorthArc(5), ArcStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s5)
  ...
  test("duplicate offsets and dithers") {
    ...
    val setup: IO[Observation.Id] =
      for {
        ...
        s0 <- recordStepAs(serviceUser, a0, Instrument.GmosNorth, gmosNorthArc(5), ArcStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s0)

        s1 <- recordStepAs(serviceUser, a0, Instrument.GmosNorth, gmosNorthFlat(5), FlatStep, gcalTelescopeConfig(0), ObserveClass.ProgramCal)
        _  <- addEndStepEvent(s1)
