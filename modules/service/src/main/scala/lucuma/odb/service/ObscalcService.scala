  ...
  object Statements:
    ...
    private def updatesForResult(
      ...
      NonEmptyList.of(
        ...
        sql"c_acq_observing_non_charged_time = ${time_span.opt}"(r.digest.map(_.acquisition.observingTime(ChargeClass.NonCharged))),
        sql"c_acq_observing_program_time     = ${time_span.opt}"(r.digest.map(_.acquisition.observingTime(ChargeClass.Program))),
        ...
        sql"c_sci_observing_non_charged_time = ${time_span.opt}"(r.digest.map(_.science.observingTime(ChargeClass.NonCharged))),
        sql"c_sci_observing_program_time     = ${time_span.opt}"(r.digest.map(_.science.observingTime(ChargeClass.Program))),
