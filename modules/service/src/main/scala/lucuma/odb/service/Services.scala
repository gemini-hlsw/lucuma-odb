...
trait Services[F[_]]:
  ...
  def obscalcService(commitHash: CommitHash, itcClient: ItcClient[F], httpClient: Client[F], ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode)(using Logger[F]): ObscalcService[F]
  ...
  def timeEstimateService(commitHash: CommitHash, itcClient: ItcClient[F], httpClient: Client[F], ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode, emailConfig: Config.Email): TimeEstimateService[F]
  ...
  def guideService(gaiaClient: GaiaClient[F], itcClient: ItcClient[F], httpClient: Client[F], commitHash: CommitHash, ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode): GuideService[F]
...
object Services:
  ...
  def forUser[F[_]](u: User, e: Enums, m: Option[Session[F] => Mapping[F]])(s: Session[F])(
    ...
    new Services[F]:
      ...
      def obscalcService(commitHash: CommitHash, itcClient: ItcClient[F], httpClient: Client[F], ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode)(using Logger[F]) = ObscalcService.instantiate(commitHash, itcClient, httpClient, ptc)
      def timeEstimateService(commitHash: CommitHash, itcClient: ItcClient[F], httpClient: Client[F], ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode, emailConfig: Config.Email) = TimeEstimateService.instantiate(commitHash, itcClient, httpClient, ptc, emailConfig)
      def guideService(gaiaClient: GaiaClient[F], itcClient: ItcClient[F], httpClient: Client[F], commitHash: CommitHash, ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode) = GuideService.instantiate(gaiaClient, itcClient, httpClient, commitHash, ptc)
  ...
  object Syntax:
    ...
    def obscalcService[F[_]](commitHash: CommitHash, itcClient: ItcClient[F], httpClient: Client[F], ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode)(using Services[F], Logger[F]): ObscalcService[F] = summon[Services[F]].obscalcService(commitHash, itcClient, httpClient, ptc)
    def timeEstimateService[F[_]](commitHash: CommitHash, itcClient: ItcClient[F], httpClient: Client[F], ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode, emailConfig: Config.Email)(using Services[F]): TimeEstimateService[F] = summon[Services[F]].timeEstimateService(commitHash, itcClient, httpClient, ptc, emailConfig)
    def guideService[F[_]](gaiaClient: GaiaClient[F], itcClient: ItcClient[F], httpClient: Client[F], commitHash: CommitHash, ptc: TimeEstimateCalculatorImplementation.ForInstrumentMode)(using Services[F]): GuideService[F] = summon[Services[F]].guideService(gaiaClient, itcClient, httpClient, commitHash, ptc)
