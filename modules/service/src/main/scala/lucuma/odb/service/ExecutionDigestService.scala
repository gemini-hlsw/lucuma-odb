    ...
    new ExecutionDigestService[F]:
      ...
      override def insertOrUpdate(
        ...
        session.execute(Statements.InsertOrUpdateExecutionDigest)(
          ...
          digest.acquisition.biases.count,
          digest.acquisition.biases.time(ChargeClass.NonCharged),
          digest.acquisition.biases.time(ChargeClass.Program),
          digest.acquisition.darks.count,
          digest.acquisition.darks.time(ChargeClass.NonCharged),
          digest.acquisition.darks.time(ChargeClass.Program),
          digest.acquisition.arcs.count,
          digest.acquisition.arcs.time(ChargeClass.NonCharged),
          digest.acquisition.arcs.time(ChargeClass.Program),
          digest.acquisition.flats.count,
          digest.acquisition.flats.time(ChargeClass.NonCharged),
          digest.acquisition.flats.time(ChargeClass.Program),
          digest.acquisition.observing.count,
          digest.acquisition.observing.time(ChargeClass.NonCharged),
          digest.acquisition.observing.time(ChargeClass.Program),
          ...
          digest.science.biases.count,
          digest.science.biases.time(ChargeClass.NonCharged),
          digest.science.biases.time(ChargeClass.Program),
          digest.science.darks.count,
          digest.science.darks.time(ChargeClass.NonCharged),
          digest.science.darks.time(ChargeClass.Program),
          digest.science.arcs.count,
          digest.science.arcs.time(ChargeClass.NonCharged),
          digest.science.arcs.time(ChargeClass.Program),
          digest.science.flats.count,
          digest.science.flats.time(ChargeClass.NonCharged),
          digest.science.flats.time(ChargeClass.Program),
          digest.science.observing.count,
          digest.science.observing.time(ChargeClass.NonCharged),
          digest.science.observing.time(ChargeClass.Program),
