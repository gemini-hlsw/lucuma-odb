    ...
    new ExecutionDigestService[F]:
      ...
      override def insertOrUpdate(
        ...
        session.execute(Statements.InsertOrUpdateExecutionDigest)(
          ...
          digest.acquisition.gcalSets,
          digest.acquisition.steps.biases.count,
          digest.acquisition.steps.biases.time(ChargeClass.NonCharged),
          digest.acquisition.steps.biases.time(ChargeClass.Program),
          digest.acquisition.steps.darks.count,
          digest.acquisition.steps.darks.time(ChargeClass.NonCharged),
          digest.acquisition.steps.darks.time(ChargeClass.Program),
          digest.acquisition.steps.arcs.count,
          digest.acquisition.steps.arcs.time(ChargeClass.NonCharged),
          digest.acquisition.steps.arcs.time(ChargeClass.Program),
          digest.acquisition.steps.flats.count,
          digest.acquisition.steps.flats.time(ChargeClass.NonCharged),
          digest.acquisition.steps.flats.time(ChargeClass.Program),
          digest.acquisition.steps.observing.count,
          ...
          digest.science.gcalSets,
          digest.science.steps.biases.count,
          digest.science.steps.biases.time(ChargeClass.NonCharged),
          digest.science.steps.biases.time(ChargeClass.Program),
          digest.science.steps.darks.count,
          digest.science.steps.darks.time(ChargeClass.NonCharged),
          digest.science.steps.darks.time(ChargeClass.Program),
          digest.science.steps.arcs.count,
          digest.science.steps.arcs.time(ChargeClass.NonCharged),
          digest.science.steps.arcs.time(ChargeClass.Program),
          digest.science.steps.flats.count,
          digest.science.steps.flats.time(ChargeClass.NonCharged),
          digest.science.steps.flats.time(ChargeClass.Program),
      ...
      sql"""
        ...
        ON CONFLICT ON CONSTRAINT t_execution_digest_pkey DO UPDATE
          SET c_hash                    = $md5_hash,
              ...
              c_acq_gcal_set_count             = $int4_nonneg,
              c_acq_bias_count                 = $int4_nonneg,
              c_acq_bias_non_charged_time      = $time_span,
              c_acq_bias_program_time          = $time_span,
              c_acq_dark_count                 = $int4_nonneg,
              c_acq_dark_non_charged_time      = $time_span,
              c_acq_dark_program_time          = $time_span,
              c_acq_arc_count                  = $int4_nonneg,
              c_acq_arc_non_charged_time       = $time_span,
              c_acq_arc_program_time           = $time_span,
              c_acq_flat_count                 = $int4_nonneg,
              c_acq_flat_non_charged_time      = $time_span,
              c_acq_flat_program_time          = $time_span,
              c_acq_observing_count            = $int4_nonneg,
              c_acq_observing_non_charged_time = $time_span,
              c_acq_observing_program_time     = $time_span,
              ...
              c_sci_gcal_set_count             = $int4_nonneg,
              c_sci_bias_count                 = $int4_nonneg,
              c_sci_bias_non_charged_time      = $time_span,
              c_sci_bias_program_time          = $time_span,
              c_sci_dark_count                 = $int4_nonneg,
              c_sci_dark_non_charged_time      = $time_span,
              c_sci_dark_program_time          = $time_span,
              c_sci_arc_count                  = $int4_nonneg,
              c_sci_arc_non_charged_time       = $time_span,
              c_sci_arc_program_time           = $time_span,
              c_sci_flat_count                 = $int4_nonneg,
              c_sci_flat_non_charged_time      = $time_span,
              c_sci_flat_program_time          = $time_span,
              c_sci_observing_count            = $int4_nonneg,
              c_sci_observing_non_charged_time = $time_span,
              c_sci_observing_program_time     = $time_span,
