    ...
    new ExecutionDigestService[F]:
      ...
      override def insertOrUpdate(
        ...
        session.execute(Statements.InsertOrUpdateExecutionDigest)(
          ...
          digest.acquisition.observingTime(ChargeClass.NonCharged),
          digest.acquisition.observingTime(ChargeClass.Program),
          ...
          digest.science.observingTime(ChargeClass.NonCharged),
          digest.science.observingTime(ChargeClass.Program),
