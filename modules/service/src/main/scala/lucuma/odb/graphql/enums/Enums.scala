...
final class Enums(
  ...
  enum TimeEstimate(val tag: String) {
    ...
    case Igrins2LongslitSetup    extends TimeEstimate("ig2_longslit_setup")
    case Igrins2Reacquisition    extends TimeEstimate("ig2_reacquisition")
    case Igrins2Write            extends TimeEstimate("ig2_write")
