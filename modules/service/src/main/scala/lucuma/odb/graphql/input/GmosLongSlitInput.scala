...
object GmosLongSlitInput:
        ...
        NorthData.rmap:
          case (
            ...
            Result(North(
              ...
              Common(
                centralWavelength,
                acqExposureTimeMode.toOption,
                sciExposureTimeMode.toOption,
                exXBin.toOption,
                exYBin.toOption,
  ...
  object Edit:
    ...
    final case class Common(
      ...
      acqExposureTimeMode: Nullable[ExposureTimeMode],
      sciExposureTimeMode: Nullable[ExposureTimeMode],
  ...
  private val NorthData: Matcher[(
    ...
    ObjectFieldsBinding.rmap:
      case List(
        ...
        ExposureTimeModeInput.Binding.Nullable("acquisitionExposureTimeMode", rAcqExposureTimeMode),
        ExposureTimeModeInput.Binding.Nullable("scienceExposureTimeMode", rSciExposureTimeMode),
