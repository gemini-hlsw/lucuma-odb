...
final case class ResetBlindOffsetTargetInput(
  observationId:  Option[Observation.Id],
  observationRef: Option[ObservationReference]
)

object ResetBlindOffsetTargetInput:

  val Binding: Matcher[ResetBlindOffsetTargetInput] =
    ObjectFieldsBinding.rmap:
      case List(
        ...
        (rObservationId, rObservationRef).mapN(ResetBlindOffsetTargetInput.apply)