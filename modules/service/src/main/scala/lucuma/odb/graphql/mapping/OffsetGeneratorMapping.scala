...
trait OffsetGeneratorMapping[F[_]] extends OffsetGeneratorView[F] with EnumeratedOffsetView[F]:
  ...
  lazy val OffsetGeneratorMappings: List[TypeMapping] =
    List(
      ...
      enumeratedOffsetGeneratorMapping(GmosNorthImagingType / "variant" / "interleaved" / "offsets"    / "enumerated", OffsetGeneratorView.Enumerated.ObservationId, EnumeratedOffsetView.ObjectObservationId),
      enumeratedOffsetGeneratorMapping(GmosNorthImagingType / "variant" / "interleaved" / "skyOffsets" / "enumerated", OffsetGeneratorView.Enumerated.ObservationId, EnumeratedOffsetView.SkyObservationId),
      enumeratedOffsetGeneratorMapping(GmosSouthImagingType / "variant" / "interleaved" / "offsets"    / "enumerated", OffsetGeneratorView.Enumerated.ObservationId, EnumeratedOffsetView.ObjectObservationId),
      enumeratedOffsetGeneratorMapping(GmosSouthImagingType / "variant" / "interleaved" / "skyOffsets" / "enumerated", OffsetGeneratorView.Enumerated.ObservationId, EnumeratedOffsetView.SkyObservationId),
