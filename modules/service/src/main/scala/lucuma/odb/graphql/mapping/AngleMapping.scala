...
trait AngleMapping[F[_]] extends ObservationView[F]
  ...
  lazy val AngleMappings: List[TypeMapping] =
    List(
      ...
      angleMappingAtPath(RandomTelescopeConfigGeneratorType / "size", TelescopeConfigGeneratorView.Size, TelescopeConfigGeneratorView.Random.ObservationId),
      angleMappingAtPath(SpiralTelescopeConfigGeneratorType / "size", TelescopeConfigGeneratorView.Size, TelescopeConfigGeneratorView.Spiral.ObservationId),
