        ...
        case List(
          ...
          (rSubtitle,
            ...
            (rTimingWindows, rScheduling).parFlatMapN {
              ...
              case (Some(t), None)    => SchedulingConstraintsInput(None, Nullable.NonNull(t), Nullable.Absent).some.success
      ...
      ObjectFieldsBinding.rmap {
        case List(
          ...
          (rSubtitle,
            ...
            rConstraintSet,
            (rTimingWindows, rScheduling).parFlatMapN {
              case (Nullable.Null,       Nullable.Absent)     => Nullable.NonNull(SchedulingConstraintsInput(None, Nullable.Null, Nullable.Absent)).success
              case (Nullable.Null,       Nullable.Null)       => Nullable.Null.success
              case (Nullable.Absent,     s)                   => s.success
              case (Nullable.NonNull(t), Nullable.Absent)     => Nullable.NonNull(SchedulingConstraintsInput(None, Nullable.NonNull(t), Nullable.Absent)).success
