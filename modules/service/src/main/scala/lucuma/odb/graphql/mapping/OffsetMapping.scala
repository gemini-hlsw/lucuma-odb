...
trait OffsetMapping[F[_]] extends EnumeratedOffsetTable[F]
  ...
  lazy val OffsetMappings: List[TypeMapping] =
    List(
      offsetMappingAtPath(EnumeratedPath, EnumeratedOffsetTable.ObservationId, EnumeratedOffsetTable.OffsetGeneratorRole, EnumeratedOffsetTable.Index),
      offsetComponentMappingAtPath(EnumeratedPath / "p", EnumeratedOffsetTable.OffsetP, EnumeratedOffsetTable.ObservationId, EnumeratedOffsetTable.OffsetGeneratorRole, EnumeratedOffsetTable.Index),
      offsetComponentMappingAtPath(EnumeratedPath / "q", EnumeratedOffsetTable.OffsetQ, EnumeratedOffsetTable.ObservationId, EnumeratedOffsetTable.OffsetGeneratorRole, EnumeratedOffsetTable.Index),
