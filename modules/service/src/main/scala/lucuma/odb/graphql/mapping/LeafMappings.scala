...
trait LeafMappings[F[_]] extends BaseMapping[F]:
  ...
  // See the codec for why MosSlitPriority cannot use its Enumerated encoder.
  ...
  lazy val LeafMappings: List[TypeMapping] =
    List(
      ...
      LeafMapping[GhostBinning](GhostBinningType),
      LeafMapping[GhostIfu1FiberAgitator](GhostIfu1FiberAgitatorType),
      LeafMapping[GhostIfu2FiberAgitator](GhostIfu2FiberAgitatorType),
      LeafMapping[GhostReadMode](GhostReadModeType),
      LeafMapping[GhostResolutionMode](GhostResolutionModeType),
      ...
      LeafMapping[GnirsAcquisitionType](GnirsAcquisitionTypeType),
      ...
      LeafMapping[SlitOffsetMode](SlitOffsetModeType),
