...
trait BaseMapping[F[_]]
  ...
  lazy val CallPropertiesType                   = schema.ref("CallProperties")
  lazy val CallPropertiesClassicalType          = schema.ref("CallPropertiesClassical")
  lazy val CallPropertiesDemoScienceType        = schema.ref("CallPropertiesDemoScience")
  lazy val CallPropertiesDirectorsTimeType      = schema.ref("CallPropertiesDirectorsTime")
  lazy val CallPropertiesFastTurnaroundType     = schema.ref("CallPropertiesFastTurnaround")
  lazy val CallPropertiesLargeProgramType       = schema.ref("CallPropertiesLargeProgram")
  lazy val CallPropertiesPoorWeatherType        = schema.ref("CallPropertiesPoorWeather")
  lazy val CallPropertiesQueueType              = schema.ref("CallPropertiesQueue")
  lazy val CallPropertiesSystemVerificationType = schema.ref("CallPropertiesSystemVerification")
