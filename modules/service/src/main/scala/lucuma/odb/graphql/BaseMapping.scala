...
trait BaseMapping[F[_]]
  ...
  lazy val GmosGroupedImagingVariantType           = schema.ref("GmosGroupedImagingVariant")
  ...
  lazy val GmosInterleavedImagingVariantType       = schema.ref("GmosInterleavedImagingVariant")
