...
trait BaseMapping[F[_]]
  ...
  lazy val F2CustomSlitWidthType                   = schema.ref("Flamingos2CustomSlitWidth")
  lazy val F2DeckerType                            = schema.ref("Flamingos2Decker")
  ...
  lazy val F2LyotWheelType                         = schema.ref("Flamingos2LyotWheel")
  lazy val F2ReadModeType                          = schema.ref("Flamingos2ReadMode")
  lazy val F2ReadoutModeType                       = schema.ref("Flamingos2ReadoutMode")
  lazy val F2ReadsType                             = schema.ref("Flamingos2Reads")
