...
trait BaseMapping[F[_]]
  ...
  lazy val GoaDuplicationType                      = schema.ref("GoaDuplication")
  lazy val GoaDuplicationStateType                 = schema.ref("GoaDuplicationState")
  lazy val GoaMatchType                            = schema.ref("GoaMatch")
  ...
  lazy val RefreshGoaDuplicationResultType         = schema.ref("RefreshGoaDuplicationResult")
