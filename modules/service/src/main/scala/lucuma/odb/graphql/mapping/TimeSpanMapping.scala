...
trait TimeSpanMapping[F[_]] extends AllocationTable[F]
  ...
  lazy val TimeSpanMappings: List[TypeMapping] =
    List(
      ...
      timeSpanMappingAtPath(ExecutionType / "originalEstimate" / "fullTimeEstimate" / "nonCharged", ObservationView.OriginalEstimate.FullNonChargedTime)(ObservationView.OriginalEstimate.SyntheticId),
      timeSpanMappingAtPath(ExecutionType / "originalEstimate" / "fullTimeEstimate" / "program", ObservationView.OriginalEstimate.FullProgramTime)(ObservationView.OriginalEstimate.SyntheticId),
