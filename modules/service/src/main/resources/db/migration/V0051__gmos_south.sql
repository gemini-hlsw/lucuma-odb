...
--- GMOS SOUTH LONG SLIT OBSERVING MODE

create table t_gmos_south_long_slit (

  c_observation_id             d_observation_id      NOT NULL,
  c_observing_mode_type        e_observing_mode_type NOT NULL DEFAULT 'gmos_south_long_slit' check (c_observing_mode_type = 'gmos_south_long_slit'),
  ...
  c_initial_fpu                d_tag                 NOT NULL             REFERENCES t_gmos_south_fpu(c_tag),
