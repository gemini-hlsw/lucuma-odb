-- GNIRS IFU telescope configs. IFU reuses c_telescope_configs (as a plain [TelescopeConfig]
-- list) with a NULL c_slit_offset_mode; long slit keeps (mode, JSON). One CHECK couples
-- both directions to the observing-mode type.
ALTER TABLE t_gnirs_spectroscopy
  ADD CONSTRAINT t_gnirs_spectroscopy_telescope_configs_check CHECK (
    CASE c_observing_mode_type
      WHEN 'gnirs_ifu' THEN c_slit_offset_mode IS NULL
...
CREATE VIEW v_gnirs_spectroscopy AS
  ...
  CROSS JOIN LATERAL (
    SELECT
      ...
      CASE
        WHEN ls.c_observing_mode_type = 'gnirs_ifu' THEN
          -- extended-source defaults (ocs GNIRS_BP.xml), full p/q with unguided sky.
          CASE ls.c_fpu_ifu
            WHEN 'LowResolution' THEN
              '[{"offset":{"p":{"microarcseconds":150000},"q":{"microarcseconds":150000}},"guiding":"ENABLED"},{"offset":{"p":{"microarcseconds":10000000},"q":{"microarcseconds":10000000}},"guiding":"DISABLED"},{"offset":{"p":{"microarcseconds":-150000},"q":{"microarcseconds":-150000}},"guiding":"ENABLED"},{"offset":{"p":{"microarcseconds":-10000000},"q":{"microarcseconds":-10000000}},"guiding":"DISABLED"}]'
            WHEN 'HighResolution' THEN
              '[{"offset":{"p":{"microarcseconds":100000},"q":{"microarcseconds":-100000}},"guiding":"ENABLED"},{"offset":{"p":{"microarcseconds":10000000},"q":{"microarcseconds":10000000}},"guiding":"DISABLED"},{"offset":{"p":{"microarcseconds":-100000},"q":{"microarcseconds":100000}},"guiding":"ENABLED"},{"offset":{"p":{"microarcseconds":-10000000},"q":{"microarcseconds":-10000000}},"guiding":"DISABLED"}]'
          END
