...
-- Adds an "is splittable" scheduling property.  This will control whether the
-- science sequence may be broken into multiple atoms.  If `true` the sequence
-- generator will produce logical atoms (calibrations + a particular instrument
-- configuration for example).  If `false` the sequence generator will always
-- produce a single atom.

ALTER TABLE t_observation
  ADD COLUMN c_is_splittable boolean NOT NULL DEFAULT true;

-- Re-create v_observation from V1162.
