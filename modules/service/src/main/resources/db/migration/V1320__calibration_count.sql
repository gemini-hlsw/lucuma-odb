-- Expected number of night-time calibration observations
-- generated for an observation.  Computed by the generator alongside the setup
-- count and carried in the execution digest; calibration observations report 0.
...
-- The value comes only from a fresh calculation, so recompute every digest.
