...
CREATE TABLE t_ghost_resolution (
  c_tag        d_tag PRIMARY KEY,
  c_short_name text  NOT NULL,
  c_long_name  text  NOT NULL
);

INSERT INTO t_ghost_resolution VALUES ('standard', 'Standard', 'Standard Resolution');
INSERT INTO t_ghost_resolution VALUES ('high',     'High',     'High Resolution'    );

CREATE TABLE t_spectroscopy_config_option_ghost_ifu (
  ...
  c_resolution d_tag NOT NULL REFERENCES t_ghost_resolution(c_tag)
);