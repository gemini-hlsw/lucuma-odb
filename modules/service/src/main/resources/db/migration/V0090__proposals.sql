...
create table t_proposal (
  ...
  c_min_percent_total d_int_percentage  null      check((c_min_percent_total is null) = (c_category = 'intensive' or c_category = 'large_program')),
  c_totalTime         interval          null      check((c_totalTime is null) = (c_category = 'intensive' or c_category = 'large_program'))
);
